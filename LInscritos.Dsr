VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} LGrados 
   Bindings        =   "LInscritos.dsx":0000
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Listado de Niños por Grados"
   ClientHeight    =   6645
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10395
   Icon            =   "LInscritos.dsx":001A
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   16711680
         Object.Caption         =   "Nombres y Apellidos"
      EndProperty
      ItemType2       =   3
